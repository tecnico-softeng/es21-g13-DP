...
import OpenQuestionDetails from '@/models/management/questions/OpenQuestionDetails';
import OpenQuestionAnswerDetails from '@/models/management/questions/OpenQuestionAnswerDetails';
import OpenQuestionStatementQuestionDetails from '@/models/statement/questions/OpenQuestionStatementQuestionDetails';
import OpenQuestionStatementAnswerDetails from '@/models/statement/questions/OpenQuestionStatementAnswerDetails';
  ...
  static getFactory(type: string): QuestionFactory {
    ...
    switch (type) {
      ...
      case QuestionTypes.OpenAnswer:
        return new OpenQuestionFactory();
...
class OpenQuestionFactory extends QuestionFactory {
  createEmptyQuestionDetails(): QuestionDetails {
    return new OpenQuestionDetails();
  }
  createQuestionDetails(details: any): QuestionDetails {
    return new OpenQuestionDetails(details);
  }
  createAnswerDetails(details: any): AnswerDetails {
    return new OpenQuestionAnswerDetails(details);
  }
  createStatementQuestionDetails(details: any): StatementQuestionDetails {
    return new OpenQuestionStatementQuestionDetails(details);
  }
  createStatementAnswerDetails(details: any): StatementAnswerDetails {
    return new OpenQuestionStatementAnswerDetails(details);
  }
  createStatementCorrectAnswerDetails(
    details: any
  ): StatementCorrectAnswerDetails {
    return new OpenQuestionStatementCorrectAnswerDetails(details);
  }
}
