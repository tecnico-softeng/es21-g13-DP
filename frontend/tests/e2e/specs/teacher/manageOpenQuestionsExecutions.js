describe('Manage Open Answer Questions Walk-through', () => {
  function validateQuestion(
    title,
    content,
    answerPrefix = 'This is the expected correct answer'
  ) {
    cy.get('[data-cy="showQuestionDialog"]')
      ...
      .within(($ls) => {
        ...
        cy.get('li').each(($el, index, $list) => {
          cy.get($el).should('contain', answerPrefix);
        });
      });
  }
  ...
  it('Creates a new Open Answer Question', function () {
    ...
    ).type('This is the expected correct answer', { force: true});
  ...
  it('Can duplicate and update answer in a open question', function () {
    cy.get('tbody tr')
      .first()
      .within(($list) => {
    ...
    cy.get(
      '[data-cy="AnswerTextArea"]'
    ).type('This is the NEW expected correct answer', { force: true});
    ...
    validateQuestionFull(
      ...
      'Cypress New Content For Question!',
      'This is the NEW expected correct answer'
    );
  });
  ...
  it ('Cannot create a open answer question with empty expected answer', function () {
    cy.get('button').contains('New Question').click();
