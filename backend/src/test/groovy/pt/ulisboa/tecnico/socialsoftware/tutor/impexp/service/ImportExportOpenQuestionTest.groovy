...
@DataJpaTest
class ImportExportOpenQuestionTest extends SpockTest{
    def questionId
    ...
    def setup() {
        ...
        def questionDetailsDto = new OpenQuestionDto()
        questionDetailsDto.setAnswer(OPEN_ANSWER_1)
    ...
    def "export and import questions to xml"() {
        ...
        questionResult.getQuestionDetailsDto().getAnswer() == OPEN_ANSWER_1
    }
