...
class ConcludeQuizTest extends SpockTest {
    ...
    def 'conclude quiz without conclusionDate, without answering'() {
        ...
        def correctOption = correctAnswerDto.getCorrectAnswerDetails().getCorrectOptionsId()
        correctOption != null
    }
    ...
    def 'conclude quiz with 1 answer containing 2 selected options, before conclusionDate'() {
        ...
        //multipleChoiceAnswerDto.setOptionId(optionOk2.getId())
        //multipleChoiceAnswerDto.setOptionId(optionKO.getId())
        ...
        ((MultipleChoiceAnswer) questionAnswer.getAnswerDetails()).getOptions().get(1) == optionOk2
        optionOk.getQuestionAnswers().contains(questionAnswer.getAnswerDetails())
        optionKO.getQuestionAnswers().contains(questionAnswer.getAnswerDetails())
        and: 'the return value is OK'
        correctAnswers.size() == 1
        def correctAnswerDto = correctAnswers.get(0)
        correctAnswerDto.getSequence() == 0 //Sequência de questões?
        correctAnswerDto.getCorrectAnswerDetails().getCorrectOptionsId() != null
        System.out.println(correctAnswerDto.getCorrectAnswerDetails())
    }
