...
public class XMLQuestionExportVisitor implements Visitor {
    ...
    public void visitItem(Item item){
        ...
        for (Item linkedItem: item.getLinks()){
            linksToString.append(String.valueOf(linkedItem.getSequence()));
        }
        itemElement.setAttribute("links", linksToString.toString());
        itemElement.setAttribute("group", item.getGroupNumber().toString());
    ...
    public void visitQuestionDetails(OpenQuestion question) {
        ...
        answerElement.setAttribute("content", question.getAnswer());
