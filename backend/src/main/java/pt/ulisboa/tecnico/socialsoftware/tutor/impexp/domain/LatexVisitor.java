...
public abstract class LatexVisitor implements Visitor {
    ...
    @Override
    public void visitQuestionDetails(OpenQuestion openAnswerQuestion) {
        this.result += "% Correct answer: " + openAnswerQuestion.getAnswer();
        this.result = this.result + "\\end{ClosedQuestion}\n}\n\n";
    }
    ...
    public void visitItem(Item item) {
        this.result = this.result + "\t\\item" + ItemCombinationQuestion.convertSequenceToLetter(item.getSequence()) + "{" + item.getContent() + "}\n";
    }
