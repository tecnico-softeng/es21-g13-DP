...
public enum ErrorMessage {
    ...
    LINK_ALREADY_EXISTS("Link from %d to %d already exists"),
    LINK_DOES_NOT_EXIST("Link from %d to %d does not exist"),
    ...
    ONE_CORRECT_OPTION_NEEDED("Questions need to have atleast 1 correct option"),
    ...
    EMPTY_ANSWER("The question cannot have an empty correct answer"),
    INVALID_GRADE("The grade must be a value between 0 and 1");
